...
pfizer_counterfactual <-  run_counterfactual(base_run = mod_run, sim_end = "2021-12-15", vacc_scenario = "pfizer-instead",
                                                                REP_START, REP_END, BURN_IN, 
                                                                BURN_IN_FINAL, ITER, ITER_FINAL, 
                                                                replic, which_pops, params,
                                                                ld, sitreps, sero, 
...
qsave(scenarios_out, file = here("output", paste0("counterfactual-scenario-output", today, ".qs"))) # Save locally
