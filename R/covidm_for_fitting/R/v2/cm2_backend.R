...
cm_source_backend = function(user_defined = NULL)
{
    ...
    user_defined_file = here(cm_path_, "model_v2/user_defined.cpp");
    new_user_defined = c(
    ...
    sourceCpp(here(cm_path_, "/model_v1/corona.cpp"), 
              rebuild  = cm_force_rebuild_,
              cacheDir = cm_build_dir_,
              verbose  = cm_build_verbose_)
    sourceCpp(here(cm_path_, "/model_v2/Rcpp_interface.cpp"), 
              rebuild  = cm_force_rebuild_,
              cacheDir = cm_build_dir_,
              verbose  = cm_build_verbose_)
}
