...
fit_wide <- pivot_wider(scenarios_out$no_vacc$counterfactual_fit, names_from = "ModelType", values_from = 9:28)
...
fig_3 <- plot_comp_hosps + plot_comp_icu + plot_comp_death + plot_layout(guides = "collect") & theme(legend.position = 'bottom', legend.justification = "centre")
...
fit_wide <- pivot_wider(scenarios_out$pfizer$counterfactual_fit, names_from = "ModelType", values_from = 9:28)
fit_wide <- as.data.table(fit_wide)
...
fit_wide <- pivot_wider(scenarios_out$pfizer_delay$counterfactual_fit, names_from = "ModelType", values_from = 9:28)
fit_wide <- as.data.table(fit_wide)
...
fit_wide <- pivot_wider(scenarios_out$az$counterfactual_fit, names_from = "ModelType", values_from = 9:28)
fit_wide <- as.data.table(fit_wide)
...
fit_wide <- pivot_wider(scenarios_out$az_delay$counterfactual_fit, names_from = "ModelType", values_from = 9:28)
fit_wide <- as.data.table(fit_wide)
...
fig_4 <- row_1 / row_2 / row_3 / row_4 / legend + plot_layout(heights = c(1, 1,1,1, 0.2)) & theme(legend.position = 'bottom', legend.justification = "centre")
...
fig_6 <- ggarrange(cont_hosp, cont_icu, cont_death, ncol = 3, font.label = list(family = plot_font), labels = c("A", "B", "C"))
