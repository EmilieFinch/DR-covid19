...
fig_1 <- ggarrange(plot_hosps, plot_icu, plot_death, plot_sero, nrow = 4, labels = c("A", "B", "C", "D"))
...
fig_2 <- ggarrange(plot_immune_states, contact_plot, plot_r, nrow = 3, labels = c("A", "B", "C"))
