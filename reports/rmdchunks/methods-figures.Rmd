...
fig_6 <- ggarrange(maps, plot_cases, nrow = 2, heights = c(1, 0.75), labels = c("", "C"), vjust =-1, font.label = list(size = 14))
...
fig_7 <- ggarrange(plot_gmobility, row2, nrow = 2, labels = c("A"))
```
